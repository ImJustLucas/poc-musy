...
export class MongoDBConfigService implements MongooseOptionsFactory {
  ...
  createMongooseOptions(): MongooseModuleOptions {
    const dsn: string = this.buildDsn(
      this._configService.get<string>("MONGODB_METHOD") || "",
      this._configService.get<string>("MONGODB_USERNAME") || "",
      this._configService.get<string>("MONGODB_PASSWORD") || "",
      this._configService.get<string>("MONGODB_SERVER_URI") || "",
      this._configService.get<string>("MONGODB_DATABASE") || "",
      this._configService.get<string>("MONGODB_PARAMS") || "",
    );
